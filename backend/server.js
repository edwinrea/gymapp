...
app.use(cors({
  origin: process.env.NODE_ENV === 'production' 
    ...
    : ['http://localhost:3000', 'http://localhost:3002', 'http://localhost:8080', 'http://localhost:8081', 'http://localhost:8090', 'http://localhost:5173', 'http://192.168.1.39:8080', 'http://192.168.1.39:8081', 'https://gym.shutils.com', 'http://gym.shutils.com']
}))
